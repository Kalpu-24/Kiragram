...
extern "C" JNIEXPORT jstring Java_org_kiragram_messenger_Utilities_readlink(JNIEnv *env, jclass clazz, jstring path) {
...
extern "C" JNIEXPORT jstring Java_org_kiragram_messenger_Utilities_readlinkFd(JNIEnv *env, jclass clazz, int fd) {
...
Java_org_kiragram_messenger_Utilities_setupNativeCrashesListener(JNIEnv *env, jclass clazz,
                                                                 jstring path) {
