...
import static org.kiragram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
import static org.kiragram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.kiragram.messenger.OpenAttachedMenuBotReceiver;
import org.kiragram.messenger.PushListenerController;
...
import org.kiragram.messenger.TopicsController;
...
import org.kiragram.messenger.voip.VideoCapturerDevice;
import org.kiragram.messenger.voip.VoIPPendingCall;
import org.kiragram.messenger.voip.VoIPService;
...
import org.kiragram.ui.Adapters.DrawerLayoutAdapter;
import org.kiragram.ui.Cells.ChatMessageCell;
...
import org.kiragram.ui.Cells.LanguageCell;
import org.kiragram.ui.Components.AlertsCreator;
import org.kiragram.ui.Components.AnimatedEmojiDrawable;
import org.kiragram.ui.Components.AppIconBulletinLayout;
import org.kiragram.ui.Components.AttachBotIntroTopView;
import org.kiragram.ui.Components.AudioPlayerAlert;
import org.kiragram.ui.Components.BatteryDrawable;
import org.kiragram.ui.Components.BlockingUpdateView;
...
import org.kiragram.ui.Components.Easings;
import org.kiragram.ui.Components.EmbedBottomSheet;
import org.kiragram.ui.Components.EmojiPacksAlert;
import org.kiragram.ui.Components.FireworksOverlay;
...
import org.kiragram.ui.Components.GroupCallPip;
...
import org.kiragram.ui.Components.PasscodeView;
import org.kiragram.ui.Components.PhonebookShareAlert;
import org.kiragram.ui.Components.PipRoundVideoView;
import org.kiragram.ui.Components.Premium.LimitReachedBottomSheet;
import org.kiragram.ui.Components.Premium.boosts.BoostPagerBottomSheet;
import org.kiragram.ui.Components.Premium.boosts.GiftInfoBottomSheet;
...
import org.kiragram.ui.Components.SearchTagsList;
import org.kiragram.ui.Components.SharingLocationsAlert;
import org.kiragram.ui.Components.SideMenultItemAnimator;
import org.kiragram.ui.Components.SizeNotifierFrameLayout;
import org.kiragram.ui.Components.StickerSetBulletinLayout;
import org.kiragram.ui.Components.StickersAlert;
import org.kiragram.ui.Components.TermsOfServiceView;
import org.kiragram.ui.Components.ThemeEditorView;
import org.kiragram.ui.Components.UndoView;
import org.kiragram.ui.Components.spoilers.SpoilerEffect2;
    ...
    private boolean handleIntent(Intent intent, boolean isNew, boolean restore, boolean fromPassword, Browser.Progress progress, boolean rebuildFragments) {
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.kiragram.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.kiragram.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.kiragram.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.kiragram.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
