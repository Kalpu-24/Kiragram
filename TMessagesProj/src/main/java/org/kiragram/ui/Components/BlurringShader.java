...
public class BlurringShader {
    ...
    public void draw(float[] oesMatrix, int texture, int textureWidth, int textureHeight) {
        ...
        org.kiragram.ui.Components.Paint.Shader.SetColorUniform(p.gradientTopHandle, gradientTop);
        org.kiragram.ui.Components.Paint.Shader.SetColorUniform(p.gradientBottomHandle, gradientBottom);
