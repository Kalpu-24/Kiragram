...
import org.kiragram.messenger.ChatMessageSharedResources;
...
import org.kiragram.messenger.MessagePreviewParams;
...
//                sendMessagesView.setOnClickListener(View -> didSendPressed());
            ...
            if (textSelectionOverlay != null) {
                ...
                addView(textSelectionOverlay, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.LEFT, 0, org.kiragram.ui.ActionBar.ActionBar.getCurrentActionBarHeight() / AndroidUtilities.density, 0, 0));
            }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            ((MarginLayoutParams) chatListView.getLayoutParams()).topMargin = org.kiragram.ui.ActionBar.ActionBar.getCurrentActionBarHeight();
            if (isLandscapeMode) {
