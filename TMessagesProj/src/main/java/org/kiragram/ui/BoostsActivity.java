...
import static org.kiragram.tgnet.TLRPC.TL_payments_checkedGiftCode.NO_USER_ID;
import static org.kiragram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_FEATURES;
...
import org.kiragram.ui.Components.LinkActionView;
...
import org.kiragram.ui.Components.Premium.boosts.cells.statistics.GiftedUserCell;
import org.kiragram.ui.Components.Premium.boosts.cells.statistics.GiveawayCell;
import org.kiragram.ui.Components.RecyclerListView;
import org.kiragram.ui.Components.ScrollSlidingTextTabStrip;
    ...
    AdapterWithDiffUtils adapter = new AdapterWithDiffUtils() {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder.getItemViewType() == BOOST_VIEW || holder.getItemViewType() == HEADER_PADDING || holder.getItemViewType() == BOTTOM_PADDING) {
                ...
                String name = LocaleController.formatPluralString("BoostingPremiumCountPlural", prepaidGiveaway.quantity);
