...
import static org.kiragram.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
import static org.kiragram.messenger.LocaleController.formatPluralString;
import static org.kiragram.messenger.LocaleController.formatString;
import static org.kiragram.messenger.LocaleController.getString;
...
import org.kiragram.PhoneFormat.PhoneFormat;
import org.kiragram.messenger.AccountInstance;
import org.kiragram.messenger.AndroidUtilities;
import org.kiragram.messenger.ApplicationLoader;
import org.kiragram.messenger.AuthTokensHelper;
import org.kiragram.messenger.BillingController;
import org.kiragram.messenger.BirthdayController;
import org.kiragram.messenger.BuildVars;
import org.kiragram.messenger.ChatObject;
import org.kiragram.messenger.ChatThemeController;
import org.kiragram.messenger.ContactsController;
import org.kiragram.messenger.DialogObject;
import org.kiragram.messenger.DocumentObject;
import org.kiragram.messenger.Emoji;
import org.kiragram.messenger.FileLoader;
import org.kiragram.messenger.FileLog;
import org.kiragram.messenger.FlagSecureReason;
import org.kiragram.messenger.ImageLoader;
import org.kiragram.messenger.ImageLocation;
import org.kiragram.messenger.ImageReceiver;
import org.kiragram.messenger.LanguageDetector;
import org.kiragram.messenger.LiteMode;
import org.kiragram.messenger.LocaleController;
import org.kiragram.messenger.MediaController;
import org.kiragram.messenger.MediaDataController;
import org.kiragram.messenger.MessageObject;
import org.kiragram.messenger.MessagesController;
import org.kiragram.messenger.MessagesStorage;
import org.kiragram.messenger.NotificationCenter;
import org.kiragram.messenger.NotificationsController;
import org.kiragram.messenger.R;
import org.kiragram.messenger.SendMessagesHelper;
import org.kiragram.messenger.SharedConfig;
import org.kiragram.messenger.SvgHelper;
import org.kiragram.messenger.UserConfig;
import org.kiragram.messenger.UserObject;
import org.kiragram.messenger.Utilities;
import org.kiragram.messenger.browser.Browser;
import org.kiragram.tgnet.ConnectionsManager;
import org.kiragram.tgnet.SerializedData;
import org.kiragram.tgnet.TLObject;
import org.kiragram.tgnet.TLRPC;
import org.kiragram.tgnet.tl.TL_fragment;
import org.kiragram.tgnet.tl.TL_stories;
import org.kiragram.ui.ActionBar.ActionBar;
import org.kiragram.ui.ActionBar.ActionBarMenu;
import org.kiragram.ui.ActionBar.ActionBarMenuItem;
import org.kiragram.ui.ActionBar.ActionBarMenuSubItem;
import org.kiragram.ui.ActionBar.ActionBarPopupWindow;
import org.kiragram.ui.ActionBar.AlertDialog;
import org.kiragram.ui.ActionBar.BackDrawable;
import org.kiragram.ui.ActionBar.BaseFragment;
import org.kiragram.ui.ActionBar.INavigationLayout;
import org.kiragram.ui.ActionBar.OKLCH;
import org.kiragram.ui.ActionBar.SimpleTextView;
import org.kiragram.ui.ActionBar.Theme;
import org.kiragram.ui.ActionBar.ThemeDescription;
import org.kiragram.ui.Business.OpeningHoursActivity;
import org.kiragram.ui.Business.ProfileHoursCell;
import org.kiragram.ui.Business.ProfileLocationCell;
import org.kiragram.ui.Cells.AboutLinkCell;
import org.kiragram.ui.Cells.CheckBoxCell;
import org.kiragram.ui.Cells.DividerCell;
import org.kiragram.ui.Cells.DrawerProfileCell;
import org.kiragram.ui.Cells.GraySectionCell;
import org.kiragram.ui.Cells.HeaderCell;
import org.kiragram.ui.Cells.NotificationsCheckCell;
import org.kiragram.ui.Cells.ProfileChannelCell;
import org.kiragram.ui.Cells.SettingsSearchCell;
import org.kiragram.ui.Cells.SettingsSuggestionCell;
import org.kiragram.ui.Cells.ShadowSectionCell;
import org.kiragram.ui.Cells.TextCell;
import org.kiragram.ui.Cells.TextCheckCell;
import org.kiragram.ui.Cells.TextDetailCell;
import org.kiragram.ui.Cells.TextInfoPrivacyCell;
import org.kiragram.ui.Cells.UserCell;
import org.kiragram.ui.Components.AlertsCreator;
import org.kiragram.ui.Components.AnimatedColor;
import org.kiragram.ui.Components.AnimatedEmojiDrawable;
import org.kiragram.ui.Components.AnimatedFileDrawable;
import org.kiragram.ui.Components.AnimatedFloat;
import org.kiragram.ui.Components.AnimatedTextView;
import org.kiragram.ui.Components.AnimationProperties;
import org.kiragram.ui.Components.AudioPlayerAlert;
import org.kiragram.ui.Components.AutoDeletePopupWrapper;
import org.kiragram.ui.Components.AvatarDrawable;
import org.kiragram.ui.Components.BackButtonMenu;
import org.kiragram.ui.Components.BackupImageView;
import org.kiragram.ui.Components.Bulletin;
import org.kiragram.ui.Components.BulletinFactory;
import org.kiragram.ui.Components.ButtonBounce;
import org.kiragram.ui.Components.CanvasButton;
import org.kiragram.ui.Components.ChatActivityInterface;
import org.kiragram.ui.Components.ChatAvatarContainer;
import org.kiragram.ui.Components.ChatNotificationsPopupWrapper;
import org.kiragram.ui.Components.ColoredImageSpan;
import org.kiragram.ui.Components.CombinedDrawable;
import org.kiragram.ui.Components.CrossfadeDrawable;
import org.kiragram.ui.Components.CubicBezierInterpolator;
import org.kiragram.ui.Components.DotDividerSpan;
import org.kiragram.ui.Components.EmojiPacksAlert;
import org.kiragram.ui.Components.EmptyStubSpan;
import org.kiragram.ui.Components.FloatingDebug.FloatingDebugController;
import org.kiragram.ui.Components.Forum.ForumUtilities;
import org.kiragram.ui.Components.FragmentContextView;
import org.kiragram.ui.Components.HintView;
import org.kiragram.ui.Components.IdenticonDrawable;
import org.kiragram.ui.Components.ImageUpdater;
import org.kiragram.ui.Components.InstantCameraView;
import org.kiragram.ui.Components.ItemOptions;
import org.kiragram.ui.Components.JoinGroupAlert;
import org.kiragram.ui.Components.LayoutHelper;
import org.kiragram.ui.Components.LinkSpanDrawable;
import org.kiragram.ui.Components.MediaActivity;
import org.kiragram.ui.Components.MessagePrivateSeenView;
import org.kiragram.ui.Components.Paint.PersistColorPalette;
import org.kiragram.ui.Components.Premium.GiftPremiumBottomSheet;
import org.kiragram.ui.Components.Premium.LimitReachedBottomSheet;
import org.kiragram.ui.Components.Premium.PremiumFeatureBottomSheet;
import org.kiragram.ui.Components.Premium.PremiumGradient;
import org.kiragram.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.kiragram.ui.Components.Premium.ProfilePremiumCell;
import org.kiragram.ui.Components.Premium.boosts.BoostRepository;
import org.kiragram.ui.Components.Premium.boosts.PremiumPreviewGiftToUsersBottomSheet;
import org.kiragram.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import org.kiragram.ui.Components.ProfileGalleryView;
import org.kiragram.ui.Components.RLottieDrawable;
import org.kiragram.ui.Components.RLottieImageView;
import org.kiragram.ui.Components.RadialProgressView;
import org.kiragram.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.kiragram.ui.Components.RecyclerListView;
import org.kiragram.ui.Components.ScamDrawable;
import org.kiragram.ui.Components.ShareAlert;
import org.kiragram.ui.Components.SharedMediaLayout;
import org.kiragram.ui.Components.SizeNotifierFrameLayout;
import org.kiragram.ui.Components.StickerEmptyView;
import org.kiragram.ui.Components.Text;
import org.kiragram.ui.Components.TimerDrawable;
import org.kiragram.ui.Components.TranslateAlert2;
import org.kiragram.ui.Components.TypefaceSpan;
import org.kiragram.ui.Components.UndoView;
import org.kiragram.ui.Components.VectorAvatarThumbDrawable;
import org.kiragram.ui.Components.voip.VoIPHelper;
import org.kiragram.ui.Stories.ProfileStoriesView;
import org.kiragram.ui.Stories.StoriesController;
import org.kiragram.ui.Stories.StoriesListPlaceProvider;
import org.kiragram.ui.Stories.StoryViewer;
import org.kiragram.ui.Stories.recorder.ButtonWithCounterView;
import org.kiragram.ui.Stories.recorder.DualCameraView;
import org.kiragram.ui.Stories.recorder.StoryRecorder;
import org.kiragram.ui.bots.BotBiometry;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new org.kiragram.ui.Business.LocationActivity());
            });
