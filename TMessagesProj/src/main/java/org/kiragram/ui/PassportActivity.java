...
import org.kiragram.messenger.MrzRecognizer;
...
import org.kiragram.messenger.SecureDocument;
import org.kiragram.messenger.SecureDocumentKey;
...
import org.kiragram.ui.Cells.TextDetailSettingsCell;
...
import org.kiragram.ui.Components.EmptyTextProgressView;
import org.kiragram.ui.Components.HintEditText;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.kiragram.ui.CameraScanActivity.TYPE_MRZ);
