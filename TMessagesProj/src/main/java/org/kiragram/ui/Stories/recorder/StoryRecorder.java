...
import static org.kiragram.messenger.AndroidUtilities.touchSlop;
...
import org.kiragram.messenger.camera.CameraController;
import org.kiragram.messenger.camera.CameraSession;
import org.kiragram.messenger.camera.CameraSessionWrapper;
...
import org.kiragram.ui.Cells.ShareDialogCell;
...
import org.kiragram.ui.Components.FilterShaders;
import org.kiragram.ui.Components.GestureDetectorFixDoubleTap;
...
import org.kiragram.ui.Components.PhotoFilterBlurControl;
import org.kiragram.ui.Components.PhotoFilterCurvesControl;
import org.kiragram.ui.Components.PhotoFilterView;
...
import org.kiragram.ui.Components.ThanosEffect;
import org.kiragram.ui.Components.URLSpanUserMention;
import org.kiragram.ui.Components.VideoEditTextureView;
import org.kiragram.ui.Components.WaveDrawable;
import org.kiragram.ui.Components.ZoomControlView;
...
import org.kiragram.ui.Stories.PeerStoriesView;
import org.kiragram.ui.Stories.StoriesController;
import org.kiragram.ui.Stories.StoryViewer;
import org.kiragram.ui.Stories.StoryWaveEffectView;
            ...
            protected boolean ignoreTouches(float x, float y) {
                ...
                for (int i = 0; i < paintView.entitiesView.getChildCount(); ++i) {
                    ...
                    if (view instanceof EntityView) {
                        org.kiragram.ui.Components.Rect rect = ((EntityView) view).getSelectionBounds();
